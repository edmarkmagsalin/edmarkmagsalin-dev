                ...
                <div className="container">
                    <div className="row">
                        <div className="col-sm-12 col-md-7">
                            ...
                            <p>
                                My experience on web developemnt is over 5 years now, I started learning web development back in 2017. I started with HTML, CSS and PHP. Then I learned JavaScript and Node.js. I also learned React and TypeScript.
                            </p>
                            <p>
